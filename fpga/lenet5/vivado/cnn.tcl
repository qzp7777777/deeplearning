...
################################################################
# This is a generated script based on design: cnn
#
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_UIPARAM_DDR_PARTNO {MT41J512M8 RA-15E} \
   CONFIG.PCW_UIPARAM_DDR_ROW_ADDR_COUNT {16} \
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins cnn_0/in_stream]
  ...
  connect_bd_intf_net -intf_net cnn_0_out_stream [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins cnn_0/out_stream]
